...
export default function AddUserOrgModal(props) {
  // props:
  // {
  //    openModal,          object consisting of {modalId, modalHdr, orgId}
  ...
  useEffect(() => {
    if (props.openModal?.modalId === "add-user-org") {
      setName("")
      setEmail("")
      setPhone("")
      setAdmin(false)
  ...
  return (
    <>
      ...
      <Modal
        // root={document.body}
        dismissible
        show={props?.openModal?.modalId === "add-user-org"}
