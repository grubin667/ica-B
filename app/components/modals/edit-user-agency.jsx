...
export default function EditUserAgencyModal(props) {
  // props:
  // {
  ...
  useEffect(() => {
    if (props.openModal?.modalId === "edit-user-agency") {
      ...
      setPhone(u?.phone || "")
      setActive(u?.active)
      // user u is connected to agency with id props.openModal.agencyId.
      // Find this cxn in u.agencies and set admin from isAgencyAdmin.
      const a = u.agencies.find(s => s.agencyId === props.openModal?.agencyId)
      setAdmin(a?.isAgencyAdmin)
    }
  }, [
    props.openModal?.agencyId,
  ...
  //////////////////////////////////////////////////////////////////////////////////////
  // SUBMIT EDIT USER
  // We are saving changes to a user already linked to an agency.
  // name, phone and active are updatable; email is immutable.
  // id is in props.openModal.idVal and, of course, isn't editable either, being the primary key.
  // There are 2 bools for us to handle: active and admin. active is part of the user;
  // admin is a prop in usersOnAgencies.
  // name, email and phone have been validated by disabling the SUBMIT button if any is empty or malformed.
  //////////////////////////////////////////////////////////////////////////////////////
  const handleSubmitEditUser = async e => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // user has been updated. Update usersOnAgencies.
        const resp2 = await fetch(`/api/usersonagencies`, {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json"
          },
          body: JSON.stringify({
            userId: props.openModal.idVal,
  ...
  return (
    <>
      ...
      <Modal
        // root={document.body}
        dismissible
        show={props?.openModal?.modalId === "edit-user-agency"}
